      ...
      <div className="flex-1 p-6 overflow-y-auto space-y-4">
        <div className="bg-white/[0.03] rounded-xl p-4 border border-white/[0.06]">
          ...
          <div className="flex justify-end items-center">
            {createMut.isError && (
              <span className="text-xs text-red-400 mr-2 self-center">保存失败，请重试</span>
            )}
            <button
              onClick={submit}
              ...
              >
                ...
                <div className="flex gap-1.5 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded-md bg-white/[0.06] hover:bg-red-500/20 text-white/60 hover:text-red-300 text-xs disabled:opacity-40"
                  >
                    删除
                  </button>
                </div>
